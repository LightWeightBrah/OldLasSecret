...
public class BlueGoblin : MonoBehaviour
{
    public Room theRoom;
    ...
    void Start()
    {
        ...
        counterToShoot = ShootCounterTIme;
        ...
        */
        ...
        switch (currenState)
        {
            case GoblinStates.Idle:
                ...
                ChangeAnimationState("BlueGoblin_Idle");
            ...
            case GoblinStates.Walk:
                ChangeAnimationState("BlueGoblin_Walk");
            ...
            case GoblinStates.TakeDamage:
                ChangeAnimationState("BlueGoblin_TakeDamage");
